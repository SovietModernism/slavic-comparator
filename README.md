...
**/console_version** - папка, в которой хранится консольная версии программы. Её может быть более удобно использовать для отладки программы и поиска ошибок (главный код там почти одинаковый), да и работает немного быстрее.
